...
public struct BonjourRequest {
    ...
    public mutating func setBody(data: Data, type: String="text") {
        body = data
    ...
    public mutating func setValue(_ value: String, forHTTPHeaderField: String) {
...
//        let (firstLine, headers, body) = try BonjourParser.perse(data: data)
        ...
        if parts.count == 3, let method = Method(rawValue: parts[0]) {
            ...
            print("Invalid Fist Line \(result.firstLine)")
